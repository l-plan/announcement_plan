...
module AnnouncementPlan
  class RecipientsControllerTest < ActionController::TestCase
    setup do
      @recipient = announcement_plan_recipients(:recipient_1)
    ...
    test "should create recipient" do
      assert_difference('Recipient.count') do
        post :create, recipient: { announcement_id: @recipient.announcement_id, user_id: @recipient.user_id }
      end
    ...
    test "should update recipient" do
      patch :update, id: @recipient, recipient: { announcement_id: @recipient.announcement_id, user_id: @recipient.user_id }
      assert_redirected_to recipient_path(assigns(:recipient))
    end
